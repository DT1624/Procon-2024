...
headers = {"Authorization": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTUsIm5hbWUiOiJibHVlY2F0IiwiaXNfYWRtaW4iOmZhbHNlLCJpYXQiOjE3MjUzNzg1MjUsImV4cCI6MTcyNTU1MTMyNX0.i4Gev7BGQ7EoYYA0MKHbkV-jpbzkrmAUjj_-Qlih6mA"}

for question_id in range(1, 75):
    # question_id = 66
    ...
    if "message" not in question: 
        ...
        with open("input" + str(question_id) + ".txt", "w") as file:
